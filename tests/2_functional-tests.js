      ...
      test('Test GET /api/books',  function(done){
        chai.request(server)
          ...
          .end((err, res) => {
            ...
            assert.property(res.body[0],'comments','the books in the arrays should have a property comments');
      ...
      test('Test POST /api/books/[id] with comment', function(done){
        chai.request(server)
            ...
            .end((err, res) => {
              ...
              assert.include(res.body.comments, 'this is comment', 'comments contains "book comment" value');
              done();
            });
      });
